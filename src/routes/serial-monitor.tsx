  ...
  return (
    <div className="card card-bordered card-compact shadow-md">
      <div className="card-body flex flex-row items-center" >
        <h1 className="text-2xl">Serial Monitor</h1>
...
function SerialStream() {
  ...
  listen<string>('serial_message_received', (event) => {
    invoke("get_serial_content")
    ...
    <div className="card card-bordered card-compact shadow-md flex-grow">
      <div className="card-body flex flex-col h-0">
        ...
        <div className="flex flex-row items-end">
          <form className="join mt-2 flex-grow"
          ...
          <button className="btn btn-neutral ms-1" onClick={() => (document.getElementById('serial-settings-modal') as HTMLDialogElement).showModal()}>settings</button>
          <dialog id="serial-settings-modal" className="modal">
            <div className="modal-box">
              ...
              <label className="form-control w-full max-w-xs">
                ...
                <select className="select select-bordered" onSubmit={(e) => { }} defaultValue={0}>
                  <option disabled value={0}>Select Baud Rate...</option>
